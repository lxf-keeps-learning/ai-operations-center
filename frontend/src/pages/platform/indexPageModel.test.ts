...
assert.equal(getOverviewSessionStatus('created'), 'running')
assert.equal(getOverviewSessionStatus('success'), 'success')
assert.equal(getOverviewSessionStatus('expired'), 'other')
assert.equal(getOverviewSessionStatus('unexpected'), 'other')
