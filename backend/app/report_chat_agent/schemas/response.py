...
class CreateSessionResponse(BaseModel):
    conversation_id: str = Field(description="统一 Conversation ID")
...
class ChatMessageResponse(BaseModel):
    runtime_session_id: str | None = Field(default=None, description="统一 Runtime Session ID")
...
class SendMessageResponse(BaseModel):
    ...
    conversation_id: str = Field(description="统一 Conversation ID")
    session_id: str = Field(description="会话 ID")
    runtime_session_id: str = Field(description="统一 Runtime Session ID")
