...
async def query_kpi(filters: dict[str, Any] | None = None) -> str:
    return await execute_query_tool("kpi_query", filters)
...
async def query_alarms(filters: dict[str, Any] | None = None) -> str:
    return await execute_query_tool("alarm_query", filters)
...
async def query_risks(filters: dict[str, Any] | None = None) -> str:
    return await execute_query_tool("risk_query", filters)
...
async def query_work_orders(filters: dict[str, Any] | None = None) -> str:
    return await execute_query_tool("work_order_query", filters)
...
async def analyze_summary(
    ...
    return await execute_analysis_tool(kpi_data, alarm_data, risk_data, work_order_data, filters)
