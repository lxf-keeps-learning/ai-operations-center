...
class TestWorkOrderDraftActionTool:
    ...
    @pytest.mark.anyio
    @pytest.mark.anyio
    async def test_generates_draft_from_alarm(self):
    ...
    @pytest.mark.anyio
    @pytest.mark.anyio
    async def test_generates_draft_from_risk(self):
        inp = WorkOrderDraftInput(
            source_type="risk",
            source_id="risk_001",
            title="2号泵振动监测与维修",
    ...
    @pytest.mark.anyio
    @pytest.mark.anyio
    async def test_generates_draft_without_source_lookup(self):
        inp = WorkOrderDraftInput(
            source_type="manual",
    ...
    @pytest.mark.anyio
    @pytest.mark.anyio
    async def test_accepts_generic_tool_input_filters(self):
        inp = BaseToolInput(
            filters={
                "source_type": "alarm",
                "source_id": "alarm_001",
    ...
    @pytest.mark.anyio
    async def test_no_real_api_call(self):
