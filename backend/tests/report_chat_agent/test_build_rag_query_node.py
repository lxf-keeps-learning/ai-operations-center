...
class TestBuildRagQueryNode:
    ...
    @pytest.mark.anyio
    async def test_query_not_just_user_question(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_doc_type_inferred_for_zhidu(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_doc_type_inferred_for_rule_question(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_doc_type_inferred_for_anli(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_doc_type_default_for_general(self) -> None:
        """一般问题 → doc_type 为全部类型。"""
        state = _state_with_abnormal(
            question="为什么这个风险排第一？",
    ...
    @pytest.mark.anyio
    async def test_no_abnormal_items_fallback_to_scene(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_risk_item_as_anchor(self) -> None:
        """使用风险项作为锚点。"""
        state = _state_with_abnormal(
    ...
    @pytest.mark.anyio
    async def test_advice_item_as_anchor(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_multiple_anchor_items(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_diff_scene_label(self) -> None:
        """不同场景对应不同前缀。"""
        state = _state_with_abnormal(
            question="这个异常怎么处理？",
    ...
    @pytest.mark.anyio
    async def test_filters_include_scene_and_permission(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_does_not_use_rag_service(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_top_k_always_5(self) -> None:
        """top_k 第一版固定为 5。"""
        state = _state_with_abnormal(
            question="这个依据什么法规？",
...
class TestBuildRagQueryNodeRewrite:
    ...
    @pytest.mark.anyio
    async def test_default_config_uses_rule_query(self) -> None:
    ...
    @pytest.mark.anyio
    async def test_llm_valid_rewrite_uses_llm(self, monkeypatch) -> None:
        ...
        monkeypatch.setattr(
            "app.report_chat_agent.nodes.build_rag_query_node.llm_client.achat",
            _fake_llm,
        )
        state = _state_for_rewrite(
            "这个有没有制度依据？",
    ...
    @pytest.mark.anyio
    async def test_llm_rewrite_no_rag_intent_from_decision(self, monkeypatch) -> None:
    ...
    @pytest.mark.anyio
    async def test_llm_rewrite_accepts_required_anchors_from_decision(self, monkeypatch) -> None:
    ...
    @pytest.mark.anyio
    async def test_llm_invalid_json_falls_back(self, monkeypatch) -> None:
        monkeypatch.setattr(
            "app.report_chat_agent.nodes.build_rag_query_node.settings.rag_use_query_rewrite",
            True,
        )
        async def _fake_llm(*a, **kw):
            return _mock_llm_result("这不是 JSON")
        monkeypatch.setattr(
            "app.report_chat_agent.nodes.build_rag_query_node.llm_client.achat",
            _fake_llm,
        )
    ...
    @pytest.mark.anyio
    async def test_llm_empty_content_falls_back(self, monkeypatch) -> None:
        monkeypatch.setattr(
            "app.report_chat_agent.nodes.build_rag_query_node.settings.rag_use_query_rewrite",
            True,
        )
    ...
    @pytest.mark.anyio
    async def test_llm_call_failure_falls_back(self, monkeypatch) -> None:
        monkeypatch.setattr(
            "app.report_chat_agent.nodes.build_rag_query_node.settings.rag_use_query_rewrite",
            True,
        )
    ...
    @pytest.mark.anyio
    async def test_llm_low_confidence_falls_back(self, monkeypatch) -> None:
        monkeypatch.setattr(
            "app.report_chat_agent.nodes.build_rag_query_node.settings.rag_use_query_rewrite",
            True,
        )
    ...
    @pytest.mark.anyio
    async def test_llm_query_missing_anchors_falls_back(self, monkeypatch) -> None:
        monkeypatch.setattr(
            "app.report_chat_agent.nodes.build_rag_query_node.settings.rag_use_query_rewrite",
            True,
        )
    ...
    @pytest.mark.anyio
    async def test_llm_query_boundary_word_falls_back(self, monkeypatch) -> None:
        monkeypatch.setattr(
            "app.report_chat_agent.nodes.build_rag_query_node.settings.rag_use_query_rewrite",
            True,
        )
    ...
    @pytest.mark.anyio
    async def test_llm_query_equals_user_question_falls_back(self, monkeypatch) -> None:
        monkeypatch.setattr(
            "app.report_chat_agent.nodes.build_rag_query_node.settings.rag_use_query_rewrite",
            True,
        )
    ...
    @pytest.mark.anyio
    async def test_llm_invalid_doc_type_cleaned(self, monkeypatch) -> None:
        monkeypatch.setattr(
            "app.report_chat_agent.nodes.build_rag_query_node.settings.rag_use_query_rewrite",
            True,
        )
    ...
    @pytest.mark.anyio
    async def test_rag_query_compatible_with_call_rag_node(self, monkeypatch) -> None:
