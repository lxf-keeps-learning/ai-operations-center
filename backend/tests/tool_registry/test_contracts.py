...
def test_rollout_percentage_is_independent_version_metadata() -> None:
    ...
    assert "gray_percentage" in version_fields
    # Policy field remains accepted for management API compatibility, but rollout ignores it.
